...
import terrax  # verify this works
...
print(f'terrax: {terrax.__version__}, {terrax.__file__}')

# -- Project information -----------------------------------------------------

project = 'Terrax'
copyright = '2026, Google LLC'
author = 'Terrax authors'
...
html_theme_options = {
    'source_repository': 'https://github.com/neuralgcm/terrax/',
    'source_branch': 'main',
...
def linkcode_resolve(domain, info):
  ...
  try:
    ...
    return None
  filename = os.path.relpath(filename, start=os.path.dirname(terrax.__file__))
  lines = f'#L{linenum}-L{linenum + len(source)}' if linenum else ''
  return f'https://github.com/neuralgcm/terrax/blob/main/terrax/{filename}{lines}'
